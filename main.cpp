...
void split27(const uint pid, DrawableHexmesh<M,V,E,F,P> & mesh){
    ...
    if (mesh.num_polys() == 1){
        std::vector<std::vector<uint>> polys(27); //provvisorio
        ...
        std::vector<vec3d> newverts(56); // 57 SOLO SE SIAMO IN UN ANGOLO
        ...
        //insert polys
        std::vector<std::vector<uint>> polys(19); //provvisorio
        uint start = mesh.num_verts();


        polys[0] = {start+0,start+1,start+14,start+13,start+3,start+4,start+18,start+17};
        polys[1] = {start+2,start+3,start+17,start+16,start+6,start+7,start+21,start+20};
        polys[2] = {start+3,start+4,start+18,start+17,start+7,start+8,start+22,start+21};
        polys[3] = {start+4,start+5,start+19,start+18,start+8,start+9,start+23,start+22};
        polys[4] = {start+7,start+8,start+22,start+21,start+10,start+11,start+26,start+25};


        polys[5] = {start+12,start+13,start+29,start+28,start+16,start+17,start+33,start+32};
        polys[6] = {start+13,start+14,start+30,start+29,start+17,start+18,start+34,start+33};
        polys[7] = {start+14,start+15,start+31,start+30,start+18,start+19,start+35,start+34};
        polys[8] = {start+16,start+17,start+33,start+32,start+20,start+21,start+37,start+36};
        polys[9] = {start+17,start+18,start+34,start+33,start+21,start+22,start+38,start+37};
        polys[10] = {start+18,start+19,start+35,start+34,start+22,start+23,start+39,start+38};
        polys[11] = {start+20,start+21,start+37,start+36,start+24,start+25,start+41,start+40};
        polys[12] = {start+21,start+22,start+38,start+37,start+25,start+26,start+42,start+41};
        polys[13] = {start+22,start+23,start+39,start+38,start+26,start+27,start+43,start+42};


        polys[14] = {start+29,start+30,start+45,start+44,start+33,start+34,start+48,start+47};
        polys[15] = {start+32,start+33,start+47,start+46,start+36,start+37,start+51,start+50};
        polys[16] = {start+33,start+34,start+48,start+47,start+37,start+38,start+52,start+51};
        polys[17] = {start+34,start+35,start+49,start+48,start+38,start+39,start+53,start+52};
        polys[18] = {start+37,start+38,start+52,start+51,start+41,start+42,start+55,start+54};

        //Ne mancano 8, quelli degli angoli con i vertici già presenti
        //Quando si seleziona un quadrante a volte (tipo negli angoli) diventa un casino, scoprire perché
